    ...
    public static readonly IEnumerable<BundleTypePrintInfo> SupportedBundleTypes =
        [
            ...
            new BundleTypePrintInfo<HostingBundleVersion>(
                ...
                CommandLineConfigs.ListHostingBundleOption)
        ];
}
