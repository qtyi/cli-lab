...
{
    private static readonly SdkVersion TestSdkVersion1 = new("3.0.100-preview5-011568");
    private static readonly SdkVersion TestSdkVersion2 = new("2.1.700");
    private static readonly RuntimeVersion TestRuntimeVersion1 = new("2.2.5");
    private static readonly RuntimeVersion TestRuntimeVersion2 = new("3.0.0-preview5-27122-01");
    private static readonly AspNetRuntimeVersion TestAspNetRuntimeVersion1 = new("2.2.6");
    private static readonly AspNetRuntimeVersion TestAspNetRuntimeVersion2 = new("3.0.0-preview6.19307.2");
    private static readonly HostingBundleVersion TestHostingBundleVersion1 = new("2.1.0-preview2-final");
    private static readonly HostingBundleVersion TestHostingBundleVersion2 = new("2.2.3", "test footnote");
